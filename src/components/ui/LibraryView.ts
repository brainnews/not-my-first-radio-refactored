...
export class LibraryView {
  ...
  /**
   * Create a simple auto-generated list section
   */
  private createAutoListSection(list: AutoGeneratedList): HTMLElement {
    const section = createElement('div', { className: 'library-auto-list-section' });
    
    // Simple section header - just the genre title
    const header = createElement('h3', { className: 'library-auto-list-title' }, [list.title]);
    ...
    // Create standard station cards for each station
